...
public class TestServiceTest {
    ...
    void executeTest() {
        ...
        given(mockIOService.readIntForRangeWithPrompt(1, 4, PROMPT, ERROR_MESSAGE)).willReturn(1);
        given(mockIOService.readIntForRangeWithPrompt(1, 3, PROMPT, ERROR_MESSAGE)).willReturn(1);
        given(mockIOService.readIntForRangeWithPrompt(1, 2, PROMPT, ERROR_MESSAGE)).willReturn(1);
